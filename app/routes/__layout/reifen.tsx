...
let scripts: ExternalScriptsFunction = () => {
  return [
    {
      src: "https://appointments.mobilapp.io/blitztermin/embed?app=20031&app_code=628e1b7343b4b6e0a3a1002bb2f39b090692d437&bts[settings]=60&bts[product_category]=126",
    },
  ];
};
...
export default function Index() {
  return <Quote text={"Einbindung für einen Räderwechsel"} />;
}
